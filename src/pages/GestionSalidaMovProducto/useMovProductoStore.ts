...
import { onSetDataMovProductos, onSetDataOpcionesSucursales, onSetDataOpcionesAlmacenes, onSetDataOpcionesProductos, type MovProductoProps } from "@/pages/GestionSalidaMovProducto/store/movProductoSlice"
...
export const useMovProductoStore = () => {
    const { post, obtener, dataxID, obtenerxID, remove, patch, searcher } = useCrudhook<MovProductoProps>('/producto-movimiento/id_tipo_mov/6046', onSetDataMovProductos)
