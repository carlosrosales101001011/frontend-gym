...
import { ModalCustomImpuesto } from "@/pages/GestionImpuestos/ModalCustomImpuesto"
import { DataTableImpuestos } from "@/pages/GestionImpuestos/DataTableImpuestos"
...
export const App = () => {
    const { searcher } = useImpuestosStore()
  ...
  return (
    <div>
      <PageBreadCumb title={'Gestion de impuestos'}/>
          ...
          <div>
              <DataTableImpuestos otrosBotones={
