...
import { onSetDataMovProductos, onSetDataOpcionesSucursales, onSetDataOpcionesAlmacenes, onSetDataOpcionesProductos, type MovProductoProps } from "@/pages/GestionMovimientoAlmacen/store/movProductoSlice"
...
export const useMovProductoStore = () => {
    const { post, obtener, dataxID, obtenerxID, remove, patch, searcher } = useCrudhook<MovProductoProps>('/producto-movimiento/id_tipo_mov/0', onSetDataMovProductos)
