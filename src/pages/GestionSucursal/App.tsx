...
import { ModalCustomSucursal } from "@/pages/GestionSucursal/ModalCustomSucursal"
import { DataTableSucursal } from "@/pages/GestionSucursal/DataTableSucursal"
...
export const App = () => {
    const { searcher } = useSucursalStore()
  ...
  return (
    <div>
      <PageBreadCumb title={'Gestion de sucursales'}/>
          <ModalCustomSucursal id={isOpenModalCustom.id} onHide={onCloseModalCustomSucursal} show={isOpenModalCustom.isOpen} />
          <div>
              <DataTableSucursal otrosBotones={
