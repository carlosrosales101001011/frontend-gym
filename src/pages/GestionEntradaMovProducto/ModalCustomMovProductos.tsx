...
import { initialStateMovProducto, type MovProductoProps } from '@/pages/GestionEntradaMovProducto/store/movProductoSlice'
...
export const ModalCustomMovProductos = ({id, onHide, show}: {id: number, onHide: ()=>void, show: boolean}) => {
    ...
    const { data:dataMotivoSalidaProducto, cargar:cargarMotivoSalidaProducto } = useTerminologiaPersona('motivoEntradaMovimientoProducto');
